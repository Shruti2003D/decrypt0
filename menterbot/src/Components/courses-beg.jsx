            ...
            <div className="course_cards">
              <div className="course_card">
                <div className="course_details">
                  ...
                  <div className="course-btn-flex">
                    <Link className="button white-orange" to="/courses/cyber-forensics">Read more</Link>
              ...
              <div className="course_card">
                <div className="course_details">
                  ...
                  <div className="course-btn-flex">
                    <Link className="button white-orange" to="/courses/masters-in-ethical-hacking">Read more</Link>
