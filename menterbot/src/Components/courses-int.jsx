    ...
    <div className="courses-int-page">
      ...
      <div className="max-w-screen-xl mx-auto px-4">
        <div className="text-center my-8">
          <h2 className="track-page-sub-heading animate__animated animate__fadeInLeft">Category</h2>
          <h1 className="teams-page-heading-one margin-top-2rem margin-2rem animate__animated animate__fadeInRight">
            Intermediate-Level
          </h1>
        </div>
        <div className="course-card-container grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-4 animate__animated animate__fadeIn">
          <div className="course_card bg-orange-500 text-white p-4 rounded-lg shadow-lg">
            <div
              className="course_img1 h-60 bg-cover bg-center rounded-t-lg"
              style={{ backgroundImage: `url(${courseIntimg})` }}
            ></div>
            <div className="course_details_in p-4 flex flex-col justify-between">
              <div>
                <h3 className="course_title text-xl font-bold mb-2">Linux/ Windows Privilege Escalation</h3>
                ...
                <p className="course-instructor text-sm">
                  Instructor: <span className="font-bold">Abhishek Chouriya</span>
                </p>
              </div>
              <div className="course-btn-flex flex justify-between mt-4">
                <Link
                  className="button white-orange bg-white text-orange-500 font-bold py-2 px-4 rounded"
                  to="/courses/linux-windows-privilege-escalation"
                >
                  Read more
                </Link>
                <a
                  className="share-button flex items-center"
                  href="#"
                  data-title="Linux/ Windows Privilege Escalation"
                  data-url="https://mentorbot.in/courses/linux-windows-privilege-escalation"
                >
                  <span>Share</span>
