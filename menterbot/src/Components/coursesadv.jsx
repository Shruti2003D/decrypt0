      ...
      <div className="max-w-screen-xl mx-auto px-4">
        ...
        <div className="course-card-container grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-4">
          <motion.div
            ...
            className="course_card bg-orange-500 text-white p-4 rounded-lg shadow-lg"
          >
            <div
              className="course_img1 h-60 bg-cover bg-center rounded-t-lg"
              style={{ backgroundImage: `url(${courseAdvimg})` }}
            ></div>
            <div className="course_details_in p-4 flex flex-col justify-between">
              ...
              <div className="course-btn-flex flex justify-between mt-4">
                ...
                >
                  <span>Share</span>
                  <img
                    className="course_share ml-2"
                    src="https://mentorbot.in/assets/white_share.svg"
                    alt="Share"
                  />
                </a>
              </div>
